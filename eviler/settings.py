"""
Django settings for eviler project.
...
SECRET_KEY = 'django-insecure-e(q@2y(*t7426k6tz-^+vyvkd6xvk@-_b$%^x@nv&plysxs=yq'
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "api.serializers.EvilerTokenObtainPairSerializer",
    "TOKEN_REFRESH_SERIALIZER": "rest_framework_simplejwt.serializers.TokenRefreshSerializer",
    "TOKEN_VERIFY_SERIALIZER": "rest_framework_simplejwt.serializers.TokenVerifySerializer",
    "TOKEN_BLACKLIST_SERIALIZER": "rest_framework_simplejwt.serializers.TokenBlacklistSerializer",
    "SLIDING_TOKEN_OBTAIN_SERIALIZER": "api.serializers.EvilerTokenObtainSlidingSerializer",
    "SLIDING_TOKEN_REFRESH_SERIALIZER": "rest_framework_simplejwt.serializers.TokenRefreshSlidingSerializer",
}

ALLOWED_HOSTS = ['localhost', '.vercel.app', '127.0.0.1', '0.0.0.0']
...
WSGI_APPLICATION = 'eviler.wsgi.application'
...
AUTH_USER_MODEL = "api.EvilerUser"
